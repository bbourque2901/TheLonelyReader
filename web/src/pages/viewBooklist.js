     ...
     mount() {
      ...
      addBooklistToPage() {
       ...
       addBooksToPage() {
           ...
           let bookHtml = '<table id="book-table"><tr><th></th><th>Title</th><th>Author</th><th>Genre</th><th>Rating</th><th>Comments</th><th>ISBN</th><th>Update Book</th><th>Remove Book</th></tr>';
           let book;
           for (book of books) {
               bookHtml += `
